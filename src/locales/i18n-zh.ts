...
- 通过[类似 markdown 的语法](https://github.com/Pizza-Studio/momotalk/blob/main/docs/How-to-use.md#%EF%B8%8F-%E7%BC%96%E8%BE%91%E6%B6%88%E6%81%AF--edit-messages)可以发送一些特殊的文字样式
...
游戏黑话搜索也是，如果发现有遗漏或者写错的，**欢迎提 [issue](https://github.com/Pizza-Studio/momotalk/issues) 或 [pr](https://github.com/Pizza-Studio/momotalk/pulls) 补充**，当然对功能和代码的好想法和优化也欢迎欢迎 ❤️
